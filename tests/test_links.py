...
class TestLinks:
    ...
    #     current_hot_it_works_text = main_page.check_home_text()
    #     assert TextData.how_it_works_text == current_hot_it_works_text and driver.current_url == Urls.main_page_url, f'Успешно перешли на главную страницу'
